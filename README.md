...
A lightweight Chrome/Firefox extension that opens a language selector for LeetCode, GeeksforGeeks, and Code360 problems, then downloads the exact starter file you choose.
...
## Features
* **Multi-Platform Support:** Open supported problem pages on LeetCode, GeeksforGeeks, or Code360 and download them from the same extension popup.
...
* **Structured Data Extraction:** Uses LeetCode's GraphQL data, GeeksforGeeks' embedded page state, and Code360's public problem APIs instead of relying on brittle selectors.
* **Smart Commenting:** Wraps the HTML-stripped problem description in the correct comment syntax for your chosen language.

## How It Works
1. Open a supported LeetCode, GeeksforGeeks, or Code360 problem page.
